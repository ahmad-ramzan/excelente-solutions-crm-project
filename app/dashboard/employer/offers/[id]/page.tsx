...
export default async function EmployerOfferDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!offer) {
    return (
      <>
        ...
        <div className="main">
          <AppTopbar section="Job Offer Details" />
                  ...
                  return isVacant ? (
                    ...
                    <div key={s.id} className="slot filled">
                      ...
                      <div>
                        ...
                        <div className="sn">
                          {s.candidates ? (
                            <Link href={`/dashboard/employer/candidates/${s.candidates.public_code}`} style={{ color: 'var(--ink)', textDecoration: 'none' }}>
                              {candidateName}
                            </Link>
                          ) : (
                            'Assigned candidate'
